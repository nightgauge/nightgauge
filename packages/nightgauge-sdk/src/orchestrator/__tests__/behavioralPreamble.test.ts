/**
 * behavioralPreamble.test.ts
 *
 * Pins the SDK copy of the #77 behavioral preamble to the measured eval
 * variant (evals/variants/behavioral-preamble.json .prepend — the single
 * source of truth), and locks the Haiku-only injection semantics.
 *
 * Counterparts: internal/execution/preamble_test.go (Go) and
 * packages/nightgauge-vscode/tests/utils/behavioral-preamble-parity.test.ts.
...
} from "../behavioralPreamble.js";

const VARIANT_PATH = path.resolve(
  __dirname,
  "../../../../../evals/variants/behavioral-preamble.json"
);
