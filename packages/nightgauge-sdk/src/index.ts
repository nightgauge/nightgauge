...
export {
  ...
  type HistoryRunStageInput,
  type HistoryRunStageTokensInput,
  ALL_DIMENSIONS,
...
export {
  ...
  // Eval → routing feedback (#4175; envelope re-key #581)
  EvalRoutingAdvisor,
  ROUTING_MODES,
  type RoutingMode,
  type Confidence,
  ...
  type Recommendation,
  type AdvisorOptions,
  // Selection query over the registry axes (#581)
  TIER_BANDS,
