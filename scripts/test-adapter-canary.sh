...
str_contains() { # str_contains <haystack> <needle> — argv, not sh -c string
  # re-quoting, so a needle/haystack containing single or double quotes
  # (YAML expressions do) is never mangled.
