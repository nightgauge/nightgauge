...
| P4  | Open VSX                                                                                                                         | **Available, not yet used.** The `nightgauge` namespace exists (ownership verification requested with the Open VSX maintainers on 2026-09-02) and `marketplace-publish.yml` takes `registries=open-vsx                                                                                                                              | both`(#1316), verifying`OVSX_PAT` first and publishing 0.x as pre-release. The first Open VSX publish is a separate decision after the Marketplace soak. |
