...
| 016 | Model-Aware Skill Overlays                | Decided   | 2026-07-25 | Base `SKILL.md` stays the single procedural source of truth; per-provider/tier/model variance ships as additive overlay fragments (`_shared/_overlays/` + per-skill `_overlays/`) composed by `nightgauge skill render`, keyed off the model registry, gated by preflight and eval evidence                                                                                                                                                                                                                                                                                                              |
