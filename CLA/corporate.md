# Nightgauge Entity (Corporate) Contributor License Agreement

**Based on the Harmony Entity Contributor License Agreement (HA-CLA-E), Version
1.0.** Outbound-license **Option Five** selected; project and governing-law
fields completed for Nightgauge. See the attribution note at the end. Individual
contributors should use [`CLA/individual.md`](individual.md) instead.

> **Plain-English summary** (this box is not part of the Agreement):
> Your company keeps the copyright to its contributions and grants Edibu, LLC a
> broad, irrevocable license to use them and to license them onward under **any**
> terms — open source or proprietary (Section 2.3, Option Five). In exchange,
> Edibu promises to **also** always keep the contribution available under the
> project's open-source license (Apache-2.0). List the people authorized to
> contribute on the company's behalf and keep that list current.
...
contributors to Us. To make this document effective, please agree to it
following the instructions in [`CLA/README.md`](README.md). This is a legally
...
[`CLA/README.md`](README.md#submitting-work-you-do-not-fully-own).
...
the Creative Commons Attribution 4.0 International (CC BY 4.0) license (including
...
[`CLA/README.md`](README.md#submitting-work-you-do-not-fully-own), if You do not
...
of the State of South Dakota, United States of America, excluding its conflicts
of law provisions. Under certain circumstances, the governing law in this
section might be superseded by the United Nations Convention on Contracts for the
...
## Signatory and authorized contributors

An authorized representative of the Legal Entity agrees to this Agreement (via
signed submission or the electronic process in [`CLA/README.md`](README.md)):
...
Employees or agents authorized to Submit Contributions on the entity's behalf.
Keep this list current by notifying Us of changes:
...
_This Agreement is adapted from the **Harmony Entity Contributor License
Agreement (HA-CLA-E), Version 1.0** (© Canonical Ltd. and the Project Harmony
contributors), which is licensed under a
...
instructions point to the project's CLA process. The signatory and
authorized-contributor block is an operational addendum, not part of the Harmony
text._
