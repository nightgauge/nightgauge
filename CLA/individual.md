# Nightgauge Individual Contributor License Agreement

**Based on the Harmony Individual Contributor License Agreement (HA-CLA-I),
Version 1.0.** Outbound-license **Option Five** selected; project and
governing-law fields completed for Nightgauge. See the attribution note at the
end.

> **Plain-English summary** (this box is not part of the Agreement):
> You keep the copyright to your contribution. You grant Edibu, LLC a broad,
> irrevocable license to use it and to license it onward under **any** terms —
> open source or proprietary (Section 2.3, Option Five). In exchange, Edibu
...
[`CLA/corporate.md`](corporate.md) instead.

---

_This Agreement is adapted from the **Harmony Individual Contributor License
Agreement (HA-CLA-I), Version 1.0** (© Canonical Ltd. and the Project Harmony
